...
then
	...
	echo  python ./sttcast.py --seconds 15000 --whisper --whmodel small --whlanguage ${whlang} --cpus $cpus --html-suffix ${whisper_suffix}_${whlang} --whtraining ${training_file} --whsusptime 10 ${mp3_whisper_files[*]}
    python ./sttcast.py --seconds 15000 --whisper --whmodel small --whlanguage ${whlang} --cpus $cpus --html-suffix ${whisper_suffix}_${whlang} --whtraining ${training_file} --whsusptime 10 ${mp3_whisper_files[*]}
